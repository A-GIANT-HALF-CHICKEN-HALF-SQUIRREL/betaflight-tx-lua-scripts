...
return {
    ...
    text = {},
    fields = {
        { t = "Band",    x = 25,  y = 14, sp = 50, min=1, max=6, vals = { 2 }, to = SMLSIZE, table = { "A", "B", "E", "F", "R", "DRLT" }, upd = function(self) self.updateVTXFreq(self) end },
        ...
        { t = "ChanID",  x = 100, y = 34, sp = 32, min=5000, max=6000, to = SMLSIZE, ro=true },
    },
    freqLookup = {
